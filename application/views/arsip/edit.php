         ...
         <div class="row">
             ...
             <?= form_open_multipart('arsip/editproses') ?> 
              ...
              <div class="form-group row">
         				...
         				<div class="col-sm-10">
                         <img src="<?= base_url('assets/surma/').$edit['gbr_surat']?>" width="120">
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                         <img src="<?= base_url('assets/surma/').$edit['lamp2']?>" width="120"> 
                     ...
                     <div class="form-group row">
         				...
         				<div class="col-sm-10">
                         <img src="<?= base_url('assets/surma/').$edit['lamp3']?>" width="120">
